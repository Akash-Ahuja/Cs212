 ...
 * NOTE: there are now standard defenses to the approach mentioned above, but
 * equally dangerous things have evolved in response.  See for example this:
 * https://en.wikipedia.org/wiki/Return-oriented_programming
 * Recently (last year or so) subtle ways to read memory you shouldn't were
 * also discovered.  For example:
 * https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)
 * https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)
 * I can explain these in some detail if you are interested.
 * */
